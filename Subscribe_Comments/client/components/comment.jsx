    ...
    return (
      <Container>
        ...
        <CommentContainer>
          ...
          <Actions>
            <LikeDislike onClick={this.likeToggle} filter={likeFilter} src="http://localhost:3002/images/up.svg"></LikeDislike>
            <LikeCount>{this.props.likes + this.state.newLike}</LikeCount>
            <LikeDislike onClick={this.dislikeToggle} filter={dislikeFilter} src="http://localhost:3002/images/down.svg"></LikeDislike>
